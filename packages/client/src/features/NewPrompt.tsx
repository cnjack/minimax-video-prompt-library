...
export function NewPrompt({ onCancel }: { onCancel: () => void }) {
  ...
  async function submit() {
    ...
    try {
      ...
      // Only flip back to the form on failure. On success, stay in the
      // "creating" state until navigation unmounts this component so the form
      // is never briefly re-rendered.
